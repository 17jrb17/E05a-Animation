...
#same deal just makes the ball
class Ball:
    def __init__(self, position_x, position_y, change_x, change_y, radius, color):
        #what a ball should look like
...
#then makes the actual game which calls upon the ball
class MyGame(arcade.Window):
    ...
    def update(self, delta_time):
        #updates where the ball is
        self.ball.update()

    def on_key_press(self, key, modifiers):
        #Allows for player to control the ball
    ...
    def on_key_release(self, key, modifiers):
        #stops the ball when no longer holding down a key
